  ...
  <body>
    ...
    <main>
      <div class="wanted-poster">
        ...
        <div class="luffy-silhouette">🏴‍☠️</div>
        <div class="wanted-bottom">DEAD OR ALIVE</div>
        <div class="bounty">3,000,000,000 BERRY</div>
      </div>
      <div class="content-card">
        <h2>Welcome Nakama!</h2>
        <p>
          One Piece adalah anime dan manga tentang petualangan Monkey D. Luffy
          untuk menjadi Raja Bajak Laut.
        </p>
        <p>
          Ia berlayar bersama kru Topi Jerami untuk menemukan harta legendaris:
          <span class="highlight">One Piece</span>.
        </p>
        <div class="divider">
          <span>⚓</span>
        </div>
        <p class="quote">"Aku akan menjadi Raja Bajak Laut!" — Monkey D. Luffy</p>
      </div>
    </main>
  </body>
</html>
